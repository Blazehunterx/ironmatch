...
import { Zap, MessageSquare, Share2, Trophy, CheckCircle2, MoreHorizontal } from 'lucide-react';
...
interface PostCardProps {
    ...
    onToggleSpot: (postId: string) => void;
    currentUserId?: string | null;
}

const PostCard = React.memo(({ post, onSelect, onToggleSpot, currentUserId }: PostCardProps) => {
    return (
        <motion.div
        ...
        >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-1">
                            ...
                            <FollowButton targetUserId={post.author_id} currentUserId={currentUserId} />
                        </div>
            ...
            <div className="p-4 flex items-center justify-between border-t border-gray-800/50 bg-gray-900/20">
                <div className="flex items-center gap-4">
                    <button
                        onClick={(e) => { e.stopPropagation(); onToggleSpot(post.id); }}
